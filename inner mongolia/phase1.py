...
class Phase1AugmentationConfig:
    def __init__(self):
        ...
        # 数据路径
        self.data_path = "data/neimenggu.xlsx"

        # 特征与目标
        self.features = ['PM10', 'SO2', 'O3', 'TEMP', 'NPBMI', 'PGCBA', 'TEP', 'PHT']
        self.target = "PTB"
        ...
        # 特征类型
        self.environmental_features = ["PM10", "SO2", "O3", 'TEMP',]
        self.remote_sensing_features = ["NDVI"]
        self.socioeconomic_features = ["NPBMI", "PGCBA", "TEP", 'PHT']
