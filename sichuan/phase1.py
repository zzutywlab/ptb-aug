...
class Phase1AugmentationConfig:
    def __init__(self):
        ...
        # 数据路径
        self.data_path = "data/sichuan.xlsx"

        # 特征与目标
        self.features = ['PM2.5', 'O3', 'WS', 'NO2', 'PEP', 'POVSI']
        self.target = "PTB"
        ...
        # 特征类型
        self.environmental_features = ["PM2.5", "O3", "WS", 'NO2']
        self.remote_sensing_features = ["NDVI"]
        self.socioeconomic_features = ["PEP", "POVSI"]
