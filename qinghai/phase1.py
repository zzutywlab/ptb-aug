...
class Phase1AugmentationConfig:
    def __init__(self):
        ...
        # 数据路径
        self.data_path = "data/qinghai.xlsx"

        # 特征与目标
        self.features = ['NO2', 'O3', 'WS', 'PRE', 'PD', 'NPBMI', 'PGCBA']
        self.target = "PTB"
        ...
        # 特征类型
        self.environmental_features = ["NO2", "O3", "WS", 'PRE']
        self.remote_sensing_features = ["NDVI"]
        self.socioeconomic_features = ["PD", "NPBMI", "PGCBA"]
