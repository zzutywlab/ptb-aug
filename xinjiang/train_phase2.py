...
COMB_CV_PARAMS = {
    "n_estimators": 89,
    "learning_rate": 0.13890017161823603,
    "max_depth": 4
}

COMB_TEST_PARAMS = {
    "n_estimators": 178,
    "learning_rate": 0.12723072772107522,
    "max_depth": 10
}
...
def main():
    ...
    model_comb_cv = build_gbdt_model(COMB_CV_PARAMS)
    model_comb_cv.fit(X_train_combined, y_train_combined)
    y_test_pred_comb_cv = model_comb_cv.predict(X_test)
