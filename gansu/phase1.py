...
class Phase1AugmentationConfig:
    def __init__(self):
        ...
        # 数据路径
        self.data_path = "data/gansu.xlsx"

        # 特征与目标
        self.features = ['PM2.5', 'SO2', 'O3', 'PD', 'URBA', 'NPBMI']
        self.target = "PTB"
        ...
        # 特征类型
        self.environmental_features = ['PM2.5', 'SO2', 'O3']
        self.remote_sensing_features = ["NDVI"]
        self.socioeconomic_features = ['PD', 'URBA', 'NPBMI']
