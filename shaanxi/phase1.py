...
class Phase1AugmentationConfig:
    def __init__(self):
        ...
        # 数据路径
        self.data_path = "data/shanxi_clean.xlsx"

        # 特征与目标
        self.features = ['PM10', 'O3', 'WS', 'RH', 'CO', 'TEP', 'PEP']
        self.target = "PTB"
        ...
        # 特征类型
        self.environmental_features = ['PM10', 'O3', 'WS', 'RH', 'CO']
        self.remote_sensing_features = ["NDVI"]
        self.socioeconomic_features = ['TEP', 'PEP']
