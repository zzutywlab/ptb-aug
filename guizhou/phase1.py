...
class Phase1AugmentationConfig:
    def __init__(self):
        ...
        # 数据路径
        self.data_path = "data/guizhou.xlsx"

        # 特征与目标
        self.features = ['O3', 'NDVI', 'PRE', 'WS', 'SO2', 'TEP', 'NPBMI']
        self.target = "PTB"
        ...
        # 特征类型
        self.environmental_features = ["O3", "PRE", "WS", 'SO2']
        self.remote_sensing_features = ["NDVI"]
        self.socioeconomic_features = ["TEP", "NPBMI"]
