...
class Phase1AugmentationConfig:
    def __init__(self):
        ...
        # 数据路径
        self.data_path = "data/guangxi.xlsx"

        # 特征与目标
        self.features = ['NDVI', 'PRE', 'PEP', 'TEP', 'O3', 'TEMP']
        self.target = "PTB"
        ...
        # 特征类型
        self.environmental_features = ["PRE", "O3", "TEMP"]
        self.remote_sensing_features = ["NDVI"]
        self.socioeconomic_features = ["PEP", "TEP", "PD", "POVSI"]
